...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Paella_Mixta_at_Celler_sa_Premsa.jpg/960px-Paella_Mixta_at_Celler_sa_Premsa.jpg',
...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/Al_pastor_tacos_-_35419459020.jpg/960px-Al_pastor_tacos_-_35419459020.jpg',
...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/Guacamole_and_chips_-_Stierch.jpg/960px-Guacamole_and_chips_-_Stierch.jpg',
...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fc/Ceviche_del_Per%C3%BA.jpg/960px-Ceviche_del_Per%C3%BA.jpg',
...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Empanadas_%28Norte_de_Santander%29.jpg/960px-Empanadas_%28Norte_de_Santander%29.jpg',
...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Arepa_filled_with_queso_llanero.jpg/960px-Arepa_filled_with_queso_llanero.jpg',
...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/Mole_poblano%2C_M%C3%A9xico.JPG/960px-Mole_poblano%2C_M%C3%A9xico.JPG',
...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Chiles_rellenos_y_capeados.jpg/960px-Chiles_rellenos_y_capeados.jpg',
...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Tamales_Mexicanos_sweet_corn_tamales_01.jpg/960px-Tamales_Mexicanos_sweet_corn_tamales_01.jpg',
...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Pozole_Rojo_Mexicano.jpg/960px-Pozole_Rojo_Mexicano.jpg',
...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/Spaghetti_Bolognese_-_Figaros%2C_Brighton_2023-10-06.jpg/960px-Spaghetti_Bolognese_-_Figaros%2C_Brighton_2023-10-06.jpg',
...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Margherita_Originale.JPG/960px-Margherita_Originale.JPG',
...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/thumb/8/85/Caesar-salad.jpg/960px-Caesar-salad.jpg',
...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Brownie_IMG_001.jpg/960px-Brownie_IMG_001.jpg',
...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/e/e5/Banana_Pancakes_Pk021.jpg',
...
select public.seed_receta(
    ...
    'https://upload.wikimedia.org/wikipedia/commons/5/58/Homemade_salmon_sushi_3.jpg',
